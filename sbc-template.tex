...
\title{Estruturas de dados eficientes\\ para algoritmo genético}

\author{Raphael R. Gonçalves\inst{1}}


\address{Instituto de Computação -- Universidade Federal do Rio Grande do Sul
  (UFRGS)\\
